    ...
    return layout({
        ...
        <section class="sourcing">
            <div class="sourcing-text">
                <h2>Say Goodbye to<br> <b style="color: #101987; margin: unset;">Fraudulent Vendors</b></h2>
        ...
        <section class="sourcing-form">
            <form method="POST" action="/sourcing" style="padding:40px 0px 0px 8px;">
                <div class="column">
