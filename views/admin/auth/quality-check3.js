...
module.exports = ({ errors }) => {
    return layout({
        content: `
        <section class="quality3-form" id="form3">
            ...
            <form method="POST" action="/quality-check3">
                <div class="column">    
                    <div class="form-group">
                        <input style="height: 177px;" type="text" placeholder="What Kind of Product(s) are you purchasing?" name="description" /><br>
                    ...
                    <div class="form-group">
                        <select name="shipmentType" id="shipmentType" required onchange="toggleShipmentInfo()">
                            <option value="" disabled selected hidden>Expected Order Value</option>
                            <option value="Air Shipment">Air Shipment</option>
                            <option value="Sea Shipment">Sea Shipment</option>
                        </select>
                        <p style="color: white; font-size: 12px; margin: unset;">${getError(errors, 'shipmentType')}</p>
                    </div>
                </div>    
